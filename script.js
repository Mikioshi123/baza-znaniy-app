document.addEventListener('DOMContentLoaded', () => {
    ...
    async function reportMissingObjection() {
        ...
        // --- ИЗМЕНЕНИЕ ЗДЕСЬ ---
        // Показываем, что запрос отправляется, прямо в интерфейсе
        ...
        try {
            ...
            // Показываем сообщение об успехе вместо кнопки
            const notFoundContainer = document.querySelector('.not-found-container');
            if (notFoundContainer) {
                notFoundContainer.innerHTML = '<p>✅ Ваш запрос успешно отправлен на доработку!</p>';
            }
