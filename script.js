document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderKnowledgeBase() {
        ...
        container.innerHTML = `
            ...
            <div class="controls"><input type="text" id="searchInput" placeholder="Введите ключевое слово для поиска..."></div>
            <div id="resultsContainer"></div>
        `;
        const searchInput = document.getElementById('searchInput');
        searchInput.addEventListener('input', (e) => {
            performSearchAndRender(e.target.value);
        });
        performSearchAndRender(''); // Начальная отрисовка
    }
