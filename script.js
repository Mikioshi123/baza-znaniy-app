document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderMainInterface(data, userName) {
        ...
        appContainer.innerHTML = `
            ...
            <p>Поиск по возражениям</p> <!-- ИСПРАВЛЕНО -->
            <div class="controls">
    ...
    function setupEventListeners(data) {
        ...
        function performSearch() {
            ...
            if (searchTerm.trim().length < fuseOptions.minMatchCharLength) { // Не ищем, если запрос слишком короткий
        ...
        renderResults(data); // Начальная отрисовка всех данных
    }
