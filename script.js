document.addEventListener('DOMContentLoaded', () => {
    ...
    function saveData(objectionId, dataToSave) {
        console.log("Preparing to save data for objection:", objectionId, "Data:", dataToSave);

        clearTimeout(saveTimeout);
        saveTimeout = setTimeout(async () => {
            console.log("Calling 'save-user-data' function...");
            try {
                ...
                if (error) {
                    console.error("Error invoking save-user-data:", error);
                ...
                tg.showAlert("Критическая ошибка при сохранении.");
            }
        }, 1000);
    }
